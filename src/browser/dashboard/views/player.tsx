...
const PlayerControl: React.FC<PlayerControlProps> = ({ playerIndex, options, selected }) => {
        ...
        <div>
          ...
          <Button
            ...
            onClick={() => {
              ...
              setPlayer([]);
              setAdditionalPlayer([]);
              setOptions((prevOptions) => prevOptions.filter((item) => !additionalPlayer.includes(item)));
